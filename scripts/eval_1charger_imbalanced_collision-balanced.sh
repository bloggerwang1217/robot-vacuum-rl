...
# 評估 1-charger Imbalanced Collision (Balanced 版本)
# 50000 步長期觀察
...
echo "=========================================="
echo "機器人吸塵器強化學習 - 1-Charger Imbalanced Collision 評估 (Balanced 版本)"
echo "=========================================="
echo "開始時間: $(date)"
...
declare -a configs=(
  "1charger-collision-50-energy-100-balanced|--initial-energy 100 --e-collision 50"
)
