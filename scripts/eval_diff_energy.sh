...
# 最大步數 (每個 evaluation 的長度)
MAX_STEPS=10000

echo "=========================================="
echo "機器人吸塵器強化學習 - 不同能量配置評估"
echo "=========================================="
echo "開始時間: $(date)"
...
declare -a configs=(
  ...
  "collision-50-robot0-1000-others-200|--robot-0-energy 1000 --robot-1-energy 200 --robot-2-energy 200 --robot-3-energy 200 --e-collision 50"
  "collision-50-robot01-1000-others-200|--robot-0-energy 1000 --robot-1-energy 1000 --robot-2-energy 200 --robot-3-energy 200 --e-collision 50"
  "collision-50-robot012-1000-robot3-200|--robot-0-energy 1000 --robot-1-energy 1000 --robot-2-energy 1000 --robot-3-energy 200 --e-collision 50"
)

total_configs=${#configs[@]}
echo "共有 $total_configs 個評估配置 - 不同能量配置 (Different Energy)"
echo ""
echo "能量配置 (不同能量)："
echo "  e-collision 10:"
...
echo "  e-collision 50:"
echo "    4. [robot0-1000] Robot 0: 1000 | Robots 1,2,3: 200"
echo "    5. [robot01-1000] Robots 0,1: 1000 | Robots 2,3: 200"
echo "    6. [robot012-1000] Robots 0,1,2: 1000 | Robot 3: 200"
echo ""
