...
# 模型目錄 (使用已訓練好的模型)
MODELS_DIR="${SCRIPT_DIR}/models/1charger-massacre_20251202_163951"
...
declare -a configs=(
  "1charger-massacre-3v1|--robot-0-energy 1000 --robot-1-energy 1000 --robot-2-energy 1000 --robot-3-energy 20 --e-collision 10"
)
...
echo ""
echo "血量配置 (虐殺模式)："
echo "  1. [3v1] Robots 0,1,2: 1000 | Robot 3: 20 (三強圍殺一個弱者)"
echo ""
