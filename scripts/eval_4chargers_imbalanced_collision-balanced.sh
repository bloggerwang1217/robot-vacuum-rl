...
# 評估 Imbalanced Collision (Balanced 版本，4 Chargers 預設)
# 50000 步長期觀察
...
echo "=========================================="
echo "機器人吸塵器強化學習 - Imbalanced Collision 評估 (Balanced 版本)"
echo "=========================================="
echo "開始時間: $(date)"
...
declare -a configs=(
  "4chargers-collision-50-energy-100-balanced|--initial-energy 100 --e-collision 50"
)

total_configs=${#configs[@]}
echo "共有 $total_configs 個評估配置 - 長期觀察版"
echo ""
echo "碰撞參數設定 (Balanced 版本)："
echo "  1. e-collision: 50 (統一)"
