...
# 參數解析：
# $1: episodes 數量（預設 2000）
# $2: epsilon decay（預設 0.999）
NUM_EPISODES=${1:-2000}
EPSILON_DECAY=${2:-0.999}
...
# 格式: "配置名稱|訓練參數"
declare -a configs=(
  "massacre-1v3-5x5-center-energy75|--env-n 5 --charger-positions 2,2 --robot-0-energy 1000 --robot-1-energy 75 --robot-2-energy 75 --robot-3-energy 75 --e-collision 20 --e-charge 20 --use-epsilon-decay --epsilon-decay $EPSILON_DECAY"
  "massacre-1v3-5x5-center-energy50|--env-n 5 --charger-positions 2,2 --robot-0-energy 1000 --robot-1-energy 50 --robot-2-energy 50 --robot-3-energy 50 --e-collision 20 --e-charge 20 --use-epsilon-decay --epsilon-decay $EPSILON_DECAY"
  "massacre-1v3-5x5-center-energy25|--env-n 5 --charger-positions 2,2 --robot-0-energy 1000 --robot-1-energy 25 --robot-2-energy 25 --robot-3-energy 25 --e-collision 20 --e-charge 20 --use-epsilon-decay --epsilon-decay $EPSILON_DECAY"
)
...
echo ""
echo "血量配置 (虐殺模式 - 敵人血量 sweep)："
echo "  [1v3-75]  Robot 0: 1000 | Robots 1,2,3: 75  (一強 vs 三中弱)"
echo "  [1v3-50]  Robot 0: 1000 | Robots 1,2,3: 50  (一強 vs 三更弱)"
echo "  [1v3-25]  Robot 0: 1000 | Robots 1,2,3: 25  (一強 vs 三非常弱)"
echo ""
echo "理論預測："
