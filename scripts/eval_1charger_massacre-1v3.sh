...
declare -a configs=(
  "1charger-massacre-1v3|--robot-0-energy 1000 --robot-1-energy 20 --robot-2-energy 20 --robot-3-energy 20 --e-collision 10"
)
...
echo ""
echo "血量配置 (虐殺模式)："
echo "  1. [1v3] Robot 0: 1000 | Robots 1,2,3: 20 (一強 vs 三弱)"
echo ""
