#!/bin/bash
# Arms Race: Speed=1 baseline (r0 same speed as r1)
# r0: HP=100, attack=50, speed=1, delta-energy reward, exclusive charging
# r1: HP=500, attack=0, speed=1, scripted seek-charger

set -e
RUN_NAME="${1:-pest_spd1}"
echo "=== Arms Race speed=1: $RUN_NAME ==="
