...
# 評估 Imbalanced Collision (Imbalanced 版本，4 Chargers 預設)
# 50000 步長期觀察
...
# 模型目錄 (使用已訓練好的模型)
MODELS_DIR="${SCRIPT_DIR}/models/4chargers-imbalanced_collision_20251203_102533"
...
echo "=========================================="
echo "機器人吸塵器強化學習 - Imbalanced Collision 評估 (Imbalanced 版本)"
echo "=========================================="
echo "開始時間: $(date)"
...
declare -a configs=(
  "4chargers-collision-50-energy-100-imbalanced|--initial-energy 100 --e-collision-active-one-sided 25 --e-collision-active-two-sided 50 --e-collision-passive 50"
)
