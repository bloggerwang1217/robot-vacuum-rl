...
# 定義評估配置 (1v3 with 敵人血量 sweep)
# 格式: "配置名稱|評估參數 (energy 要與訓練時一致)"
declare -a configs=(
  "massacre-1v3-5x5-center-energy75|--env-n 5 --charger-positions 2,2 --robot-0-energy 1000 --robot-1-energy 75 --robot-2-energy 75 --robot-3-energy 75 --e-collision 20 --e-charge 20"
  "massacre-1v3-5x5-center-energy50|--env-n 5 --charger-positions 2,2 --robot-0-energy 1000 --robot-1-energy 50 --robot-2-energy 50 --robot-3-energy 50 --e-collision 20 --e-charge 20"
  "massacre-1v3-5x5-center-energy25|--env-n 5 --charger-positions 2,2 --robot-0-energy 1000 --robot-1-energy 25 --robot-2-energy 25 --robot-3-energy 25 --e-collision 20 --e-charge 20"
)

total_configs=${#configs[@]}
echo "共有 $total_configs 個評估配置 - 敵人血量 sweep 版"
echo ""
echo "血量配置 (虐殺模式 - 敵人血量 sweep)："
echo "  1. [1v3-75]  Robot 0: 1000 | Robots 1,2,3: 75  (敵人中弱)"
echo "  2. [1v3-50]  Robot 0: 1000 | Robots 1,2,3: 50  (敵人更弱)"
echo "  3. [1v3-25]  Robot 0: 1000 | Robots 1,2,3: 25  (敵人非常弱)"
echo ""
echo "評估參數（與訓練時相同）："
echo "  - e-collision: 20"
echo "  - e-charge: 20"
