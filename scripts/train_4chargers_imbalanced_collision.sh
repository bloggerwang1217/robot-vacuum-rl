...
MODELS_DIR="${SCRIPT_DIR}/models/imbalanced_collision_$(date +%Y%m%d_%H%M%S)"

echo "=========================================="
echo "機器人吸塵器強化學習 - Imbalanced Collision 訓練(Default 4 chargers)"
echo "=========================================="
echo "開始時間: $(date)"
...
# 定義訓練配置
declare -a configs=(
  "collision-50-energy-100-balanced|--e-collision 50 --initial-energy 100 --use-epsilon-decay"
  "collision-50-energy-100-imbalanced|--e-collision-active-one-sided 25 --e-collision-active-two-sided 50 --e-collision-passive 50 --initial-energy 100 --use-epsilon-decay"
)
