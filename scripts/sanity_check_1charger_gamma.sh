...
BASE_MODELS_DIR="${SCRIPT_DIR}/models/sanity_checks_1charger_$(date +%Y%m%d_%H%M%S)"

echo "==========================================================="
echo "Running Sanity Check Experiments (1 Charger at center)"
echo "Global settings: --num-episodes 2000, --max-episode-steps 1000"
echo "Charger configuration: --charger-positions \"1,1\""
echo "Results will be saved under: ${BASE_MODELS_DIR}"
echo "==========================================================="

declare -a configs=(
  "sanity-1charger-c10-e100-eps0-gamma0|--e-collision 10 --initial-energy 150 --epsilon 0 --gamma 0"
)
